...
public class BikingV8Tester
{
    public static void main(String[] args)
    {
        ...
        BikingV8[] bikes = {new BikingV8(initialMiles1, finalMiles1, startTime1, endTime1), new BikingV8(initialMiles2, finalMiles2, startTime2, endTime2), new BikingV8(initialMiles3, finalMiles3, startTime3, endTime3), new BikingV8(initialMiles4, finalMiles4, startTime4, endTime4), new BikingV8(initialMiles5, finalMiles5, startTime5, endTime5)};

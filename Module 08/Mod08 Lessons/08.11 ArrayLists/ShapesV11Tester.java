...
public class ShapesV11Tester
{
    public static void main(String[] args)
    {
        ...
        for(int index = 0; index < shapes.size(); index++)
        {
            ...
            //or if there is no dataRecord object...
            //shapes.get(index).calcTriArea();
            //shapes.get(index).calcHypotenuse();
        }
        ...
        for(int index = 0; index < shapes.size(); index++)
        {
            ...
            //if I'm not mistaken, toString() is automatically overridden
            //and applied on the object part (shapes.{}) in any print method
            //but you could call it manually shapes.{}.toString()
        }
    }//end main
}//end class
